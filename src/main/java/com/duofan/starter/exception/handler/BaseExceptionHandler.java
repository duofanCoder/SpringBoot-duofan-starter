package com.duofan.starter.exception.handler;
...
//            logFormat(ex.getMessage(), uri);
//            return new ResponseEntity(Response.error().setMessage(bindingResult.getAllErrors().get(0).getDefaultMessage()), HttpStatus.OK);
